...
- **试用已发布的预览包**：[下载 Apple Silicon 预览版](https://github.com/zhouao010809-code/best-partners/releases/tag/v0.1.5)。该版本发布于 2026-09-26，尚未完成 Developer ID 签名和 Apple 公证，请先阅读 Release 安装说明。
