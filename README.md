...
| 在项目中复用积累 | 绑定已有项目文件夹，围绕项目资料提问，并检索全局知识库；确认后的产出保存到项目的 `AI工作区`。 |
...
- **试用已发布的预览包**：[下载 Apple Silicon 预览版](https://github.com/zhouao010809-code/best-partners/releases/tag/v0.1.2)。该版本发布于 2026-09-26，尚未完成 Developer ID 签名和 Apple 公证，请先阅读 Release 安装说明。
