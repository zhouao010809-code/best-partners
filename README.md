...
| 在项目中创作内容 | 绑定项目文件夹，保存受众与表达风格，选择本条参考资料，策划短视频选题、编辑脚本；保留版本与定稿，确认后导出到项目 `AI工作区`。 |
...
- **试用已发布的预览包**：[下载 Apple Silicon 预览版](https://github.com/zhouao010809-code/best-partners/releases/tag/v0.1.6)。该版本发布于 2026-09-26，尚未完成 Developer ID 签名和 Apple 公证，请先阅读 Release 安装说明。
